...
[Click for CSS & JavaScript Toolbox PLUS](https://css-javascript-toolbox.com/?utm_source=cjt_free_on_wordpress&utm_medium=readme_txt_description&utm_campaign=click_for_premium_link)
...
* Enhancement: Improved plugin stability
* Update: ACE editor to version 1.35.3
* Fix: Resolved main controller dirname null string issue
* Fix: Compatibility issues with PHP > 8.0
* Fix: Notice warning errors in WordPress dashboard area
